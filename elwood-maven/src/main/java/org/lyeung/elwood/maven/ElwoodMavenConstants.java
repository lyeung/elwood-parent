...
import com.github.lyeung.elwood.maven.runlistener.ElwoodRunListener;
...
public final class ElwoodMavenConstants {
    ...
    public static final String ELWOOD_RUN_LISTENER_GROUP_ID = "com.github.lyeung";

    public static final String ELWOOD_RUN_LISTENER_ARTIFACT_ID = "elwood-maven-runlistener";

    public static final String ELWOOD_RUN_LISTENER_VERSION = "1.0.0-SNAPSHOT";
