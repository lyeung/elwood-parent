...
public class BuildArticleCommandImplTest {

    private static final String KEY = "KEY123";

    private BuildArticleCommandImpl impl;
    ...
    public void setUp() throws IOException {
        ...
        impl = new BuildArticleCommandImpl(projectRepository, buildRepository, buildMapLog);
    }
